...
interface ExportPageProps {
  initialSoilsData: TsoilSchema[]; 
  initialPileData: TpileSchema | null;
  initialFactorsData: TsafetySchema | null;
}
...
export default function Export({ 
  ...
  const generatePDF = async () => {
    try {
      ...
      const soilsData = initialSoilsData;
      const pileData = initialPileData;
      const factorsData = initialFactorsData;
