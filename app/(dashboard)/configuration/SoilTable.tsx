...
import type { TsoilSchema } from "@/app/lib/schemas/soilSchema"
...
export default function SoilTable({ soilsData }: { soilsData: TsoilSchema[] }) {
  ...
  return (
    <>
      <Toolbar onDelete={() => setIsDeleteDialogOpen(true)} onEdit={handleEdit} canDelete={selectedRow !== null} canEdit={selectedRow !== null}/>
