  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col flex-1 min-h-0 relative">
        ...
        <header className="mt-5 min-h-0 overflow-auto scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-slate-400 scrollbar-track-slate-200 scrollbar-hover:scrollbar-thumb-slate-500 scrollbar-active:scrollbar-thumb-slate-600">
