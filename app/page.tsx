...
import pageBackground from '@/public/pageBackground.jpg'
import logo from '@/public/logo.png'

export default function LandingPage() {
  return (
    <main className="h-screen overflow-y-auto overflow-x-clip relative">
      <Image src={pageBackground} alt='Background' placeholder='blur' fill className='-z-10 object-cover'/>
      ...
      <header className="bg-background dark:bg-secondary p-3 flex flex-col items-center space-y-2 shadow-lg sm:flex-row sm:space-y-0 sm:gap-5 sm:justify-center">
        <Image src={logo} alt='Company Logo' width={624} height={128} loading='eager' className='w-3xs'/>
